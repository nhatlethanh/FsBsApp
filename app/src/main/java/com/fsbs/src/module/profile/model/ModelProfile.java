package com.fsbs.src.module.profile.model;
...
import com.fsbs.src.module.profile.presenter.PresenterProfile;
    ...
    public void uploadImageToServer(MultipartBody.Part value) {
        ...
        callUpload.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    Log.d("FsBs", "onResponse: thanh cio");
                } else {
                    Log.d("FsBs", "onResponse: " + response.errorBody());
                }
            }
